...
public class WordBoardKarateSecondChanceSessionStateManager extends WordBoardKarateSessionStateManager {
    ...
    public WordBoardKarateSecondChanceSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivityManager activityManager, PowerUpsManager powerUpsManager, MissionManager missionManager) {
