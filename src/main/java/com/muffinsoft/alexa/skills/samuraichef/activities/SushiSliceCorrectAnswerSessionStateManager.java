...
public class SushiSliceCorrectAnswerSessionStateManager extends SushiSliceSessionStateManager {
    ...
    public SushiSliceCorrectAnswerSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivityManager activityManager, AliasManager aliasManager, MissionManager missionManager) {
