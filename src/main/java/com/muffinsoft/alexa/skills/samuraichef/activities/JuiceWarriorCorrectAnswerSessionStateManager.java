...
public class JuiceWarriorCorrectAnswerSessionStateManager extends JuiceWarriorSessionStateManager {
    ...
    public JuiceWarriorCorrectAnswerSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, LevelManager levelManager, PowerUpsManager powerUpsManager, ProgressManager progressManager) {
