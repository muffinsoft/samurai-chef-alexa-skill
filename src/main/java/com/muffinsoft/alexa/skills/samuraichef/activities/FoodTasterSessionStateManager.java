...
public class FoodTasterSessionStateManager extends BaseActivePhaseSamuraiChefSessionStateManager {
    ...
    public FoodTasterSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivityManager activityManager, AliasManager aliasManager, MissionManager missionManager, String userId) {
