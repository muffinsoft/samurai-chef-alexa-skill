...
public class WordBoardKarateSecondChanceSessionStateManager extends WordBoardKarateSessionStateManager {
    ...
    public WordBoardKarateSecondChanceSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivitiesManager activitiesManager, LevelManager levelManager, PowerUpsManager powerUpsManager, ProgressManager progressManager) {
