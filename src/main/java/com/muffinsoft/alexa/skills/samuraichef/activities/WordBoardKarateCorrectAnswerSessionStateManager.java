...
public class WordBoardKarateCorrectAnswerSessionStateManager extends WordBoardKarateSessionStateManager {
    ...
    public WordBoardKarateCorrectAnswerSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivityManager activityManager, PowerUpsManager powerUpsManager, MissionManager missionManager) {
