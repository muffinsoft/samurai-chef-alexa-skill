...
public class SushiSliceSecondChanceSessionStateManager extends SushiSliceSessionStateManager {
    ...
    public SushiSliceSecondChanceSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, LevelManager levelManager, PowerUpsManager powerUpsManager, ProgressManager progressManager) {
