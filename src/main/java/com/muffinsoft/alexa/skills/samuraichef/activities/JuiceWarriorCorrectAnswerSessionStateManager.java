...
public class JuiceWarriorCorrectAnswerSessionStateManager extends JuiceWarriorSessionStateManager {
    ...
    public JuiceWarriorCorrectAnswerSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivityManager activityManager, PowerUpsManager powerUpsManager, MissionManager missionManager) {
