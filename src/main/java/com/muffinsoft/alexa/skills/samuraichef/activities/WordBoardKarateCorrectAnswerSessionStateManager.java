...
public class WordBoardKarateCorrectAnswerSessionStateManager extends WordBoardKarateSessionStateManager {
    ...
    public WordBoardKarateCorrectAnswerSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivityManager activityManager, AliasManager aliasManager, MissionManager missionManager, String userId) {
