...
public class SushiSliceCorrectAnswerSessionStateManager extends SushiSliceSessionStateManager {
    ...
    public SushiSliceCorrectAnswerSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, LevelManager levelManager, PowerUpsManager powerUpsManager, ProgressManager progressManager) {
