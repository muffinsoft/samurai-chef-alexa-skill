...
public class SushiSliceSecondChanceSessionStateManager extends SushiSliceSessionStateManager {
    ...
    public SushiSliceSecondChanceSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivitiesManager activitiesManager, LevelManager levelManager, PowerUpsManager powerUpsManager) {
