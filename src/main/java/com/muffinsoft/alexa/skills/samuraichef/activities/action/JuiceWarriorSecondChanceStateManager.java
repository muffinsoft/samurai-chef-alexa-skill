...
public class JuiceWarriorSecondChanceStateManager extends JuiceWarriorStateManager {
    ...
    public JuiceWarriorSecondChanceStateManager(Map<String, Slot> slots, AttributesManager attributesManager, SettingsDependencyContainer settingsDependencyContainer, PhraseDependencyContainer phraseDependencyContainer) {
