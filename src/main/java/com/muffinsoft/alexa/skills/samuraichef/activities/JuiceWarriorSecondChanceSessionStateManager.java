...
public class JuiceWarriorSecondChanceSessionStateManager extends JuiceWarriorSessionStateManager {
    ...
    public JuiceWarriorSecondChanceSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivityManager activityManager, AliasManager aliasManager, MissionManager missionManager) {
