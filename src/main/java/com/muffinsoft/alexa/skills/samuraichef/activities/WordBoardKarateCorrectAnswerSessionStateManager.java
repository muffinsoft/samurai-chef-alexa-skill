...
public class WordBoardKarateCorrectAnswerSessionStateManager extends WordBoardKarateSessionStateManager {
    ...
    public WordBoardKarateCorrectAnswerSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, ActivitiesManager activitiesManager, LevelManager levelManager, PowerUpsManager powerUpsManager, ProgressManager progressManager) {
