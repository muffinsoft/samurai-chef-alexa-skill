...
public class JuiceWarriorSecondChanceSessionStateManager extends JuiceWarriorSessionStateManager {
    ...
    public JuiceWarriorSecondChanceSessionStateManager(Map<String, Slot> slots, AttributesManager attributesManager, PhraseManager phraseManager, LevelManager levelManager, PowerUpsManager powerUpsManager, ProgressManager progressManager) {
